...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/omkar-kumbhar-b0035428b/",
    color: "#0A66C2",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Omkar Kumbhar",
    icon: Youtube,
    url: "https://www.youtube.com/@omkarkumbhar178",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Omkar8552",
    icon: Github,
    url: "https://github.com/Omkar8552",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [youtube, github] = otherLinks;
...
>
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        {/* Second Row - YouTube & GitHub */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[youtube, github].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
